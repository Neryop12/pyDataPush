...
def fb_camp(conn):
    ...
    try:
        #QUERYS
        GuardarDailycampaing="""INSERT INTO dailycampaing(CampaingID,Reach,Frequency,Impressions,Clicks,cost,Campaignlifetimebudget,EndDate,VideoWatches75,PostReaccion,Result) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"""
        campanas=[]
        for atr in temp_k:
            #ACCOUNT
