...
def CuentasCampanas(conn):
    try:
            ...
            json={
                ...
                "filter": {
                    "date": {
                        ...
                        "to": str(datetime.now() + timedelta(days=15))
                    }
                },
                "paging": {
                    "offset": 0,
        ...
        sql.connect.insertReportingDiarioCampanas(diarios, media, conn)
...
def Adsets(conn):
    try:
        ...
        sql.connect.insertMetricasAdSet(metricasadsets, media, conn)
...
def Ads(conn):
    try:
        ...
        sql.connect.insertMetricasAd(metricasads, media, conn)
